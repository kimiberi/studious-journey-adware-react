...
import data_campaignRegistrations from "../../data_campaignRegistrations"
// import testProducts from "../../testProducts"

import "antd/dist/antd.css"
import "../../assets/scss/registrations table/campaign_registrations.scss"
...
const CampaignRegistrations = () => {
  ...
  const customFetch = async (params = {}) => {
    ...
    setUserList(data_campaignRegistrations.types)
  ...
  return (
    <div>
      <Table
        ...
        className='campaign-registrations-style'
      />
    </div>
  )
}
