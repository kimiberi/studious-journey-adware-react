...
import data_validRegistrations from "../../data_validRegistrations"
// import testProducts from "../../testProducts"

import "antd/dist/antd.css"
import "../../assets/scss/reports table/valid_registration.scss"
...
const ValidRegistration = () => {
  ...
  const customFetch = async (params = {}) => {
    ...
    setUserList(data_validRegistrations.types)
    // console.log(data_validRegistrations.types)
  ...
  return (
    <div>
      <Table
        ...
        className='valid-registration-style'
      />
    </div>
  )
}
